...
public class CitaVolley {
    ...
    public static void getAllCiclo(){
        ...
        String url = ruta + "/ListarActividad";
        // prepare the Request
    ...
    public static void getAllCicloByHistorial(){
        ...
        String url = ruta + "/ListarActividadByHistorial/"+ getDefault(AppController.getInstance().getContentResolver());
        // prepare the Request
    ...
    public static void addCita(Cita cita, final boolean conSincronizacionRegistro, final int idSincronizacionRegistro){
        ...
        String url = ruta +"/GuardarActividad";
